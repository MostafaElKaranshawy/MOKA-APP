...
likeRouter.post('/posts/:postID/likes', likeController.addPostLike);                                        // add likes on a post
likeRouter.post('/posts/:postID/comments/:commentID/likes', likeController.addCommentLike);                 // add likes on a comment on a post
